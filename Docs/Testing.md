...
Тестовый слой проверяет три уровня: от изолированного парсинга текста до полного цикла фото → OSM-теги. В основе — набор реальных фотографий вывесок (~695 шт.) с эталонными JSON-файлами.

```
Fixtures/Photos/        ← реальные фото (не в git, ~200 МБ после сжатия)
Fixtures/Expected/      ← эталонные JSON (в git, 678 файлов)
...
## Метрики качества (последний прогон — май 2026)

| Поле | Результат | Скор |
|---|---|---|
| `addr:door` | 30/30 | ✅ 100% |
| `ref:OGRN` | 106/110 | ✅ 96% |
| `contact:website` | 79/82 | ✅ 96% |
| `operator` | 236/251 | ✅ 94% |
| `phone` | 137/146 | ✅ 93% |
| `ref:INN` | 157/168 | ✅ 93% |
| `shop` | 265/289 | ✅ 91% |
| `amenity` | 158/187 | ✅ 84% |
| `addr:street` | 193/230 | ✅ 83% |
| `addr:city` | 124/148 | ✅ 83% |
| `addr:postcode` | 95/121 | ⚠️ 78% |
| `addr:housenumber` | 165/215 | ⚠️ 76% |
| `cuisine` | 17/24 | ⚠️ 70% |
| `brand` | 80/117 | ⚠️ 68% |
| `name` | 203/321 | ⚠️ 63% |
| `opening_hours` | 208/426 | ❌ 48% |
| `office` | 0/31 | ❌ 0% |
| `healthcare` | 0/6 | ❌ 0% |
| `leisure` | 0/6 | ❌ 0% |

**Общий скор: 77%** (порог: 50%) — 664 фикстуры
